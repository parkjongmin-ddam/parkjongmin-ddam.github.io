---
layout: single
title: "[패스트캠퍼스] 강수진 박사의 프롬프트 엔지니어링 A to Z 강의 요약"
excerpt: "국내 1호 프롬프트 엔지니어에게 배우는 생성형 AI 활용과 프롬프트 설계의 모든 것"
categories:
  - AI
tags:
  - PromptEngineering
...
최근 챗GPT 같은 AI가 똑똑해졌다고 하지만, 막상 질문을 던져보면 원하는 답이 나오지 않을 때가 많음. 이 강의는 **"AI에게 질문(프롬프트)을 어떻게 던져야 최고의 결과물을 얻을 수 있는가?"**를 심도 있게 다룸.

언어학 박사이자 국내 1호 프롬프트 엔지니어인 강수진 강사님이 AI와 '대화'하는 법을 인문학적 관점과 엔지니어링 기법을 결합하여 설명함.
...
---
### 🏁 요약 마무리
이 강의는 뻔하게 "챗GPT 잘 쓰는 법" 정도가 아니라, 생성형 AI의 본질적인 작동 원리를 이해하고 구조화된 명령(프롬프트)을 내리는 체계적인 방법론을 다루고 있음. 이 수업을 다 들으면 AI라는 강력한 무기를 자유자재로 다루는 사령관이 될 수 있음!
