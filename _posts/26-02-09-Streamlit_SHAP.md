...
머신러닝 모델의 예측을 설명하는 것은 단순히 기술적 요구사항이 아니라, **신뢰할 수 있는 AI**를 만들기 위한 필수 요소임. SHAP과 Streamlit을 결합하여 누구나 쉽게 모델을 이해하고 분석할 수 있는 도구를 만들 수 있었음.
